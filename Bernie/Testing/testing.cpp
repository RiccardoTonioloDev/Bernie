...
int main() {
    ...
    VerifyPasswordInFileTest("./Databases4Testing/prova1.txt", false, "wrong password",
                             "wrong password test");
    VerifyPasswordInFileTest("./Databases4Testing/prova1.txt", true, "1234", "right password");
