...
CreditCard::CreditCard(std::vector<std::string> serializedVectorized): SerializableObject(serializedVectorized[1]), owner(serializedVectorized[2]), number(serializedVectorized[3]),cvv(serializedVectorized[4]),
